...
import com.kutayacaar.javamaps.adapter.PlaceAdapter;
import com.kutayacaar.javamaps.databinding.ActivityMainBinding;
...
//https://developer.android.com/training/data-storage/room#java
//https://developer.android.com/training/data-storage/room#java Burdaki kodları entegre ettik
...
menuInflater.inflate(R.menu.travel_menu,menu);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId()==R.id.Mekan_ekle){
